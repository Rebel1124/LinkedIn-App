          ...
          <CardContent className="p-4 sm:p-6">
            <div className="space-y-3">
              {trendingHeadlines[selectedTheme as keyof typeof trendingHeadlines]?.slice(0, 3).map((headline, index) => (
                ...
                >
                  <div className="flex-shrink-0 w-8 h-8 bg-white rounded-full border text-blue-700 border-blue-400 hover:bg-blue-200 flex items-center justify-center">
              ...
              {generatedPosts.map((post, index) => (
                ...
                >
                  <div className="aspect-video relative">
                    ...
                    />
                    <Badge
                      className="absolute top-2 sm:top-3 right-2 sm:right-3 bg-blue-100 text-blue-800 border border-blue-400 hover:bg-yellow-100 hover:text-yellow-800 hover:border-yellow-400 font-medium text-xs sm:text-sm px-2 sm:px-3 py-1 rounded-full shadow-lg"
                    >
                    ...
                    <div className="absolute top-2 sm:top-3 left-2 sm:left-3 bg-white/90 backdrop-blur-sm rounded-full px-2 py-1">
                      <span className="text-xs font-bold text-blue-600">Post #{index + 1}</span>
                    </div>
                  </div>
