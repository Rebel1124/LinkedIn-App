            ...
            <Button
              ...
              className={`w-full ${
                generatedPosts.length > 0
                  ? "bg-gradient-to-r from-blue-300 via-yellow-200 to-blue-300 hover:from-blue-400 hover:via-yellow-300 hover:to-blue-400 text-gray-400"
              ...
              } text-gray-400 font-bold py-3 sm:py-4 rounded-xl text-base sm:text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300`}
              size="lg"
            >
              {isGenerating ? (
                <>
              ...
              {generatedPosts.map((post, index) => (
                ...
                >
                  <div className="aspect-video relative">
                    ...
                    />
                    <Badge
                      className="absolute top-2 sm:top-3 right-2 sm:right-3 bg-white text-yellow-800 border border-yellow-400 text-xs sm:text-sm px-2 sm:px-3 py-1 rounded-full shadow-lg"
                    >
